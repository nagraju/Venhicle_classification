...
PREDICTED_LABELS = ["Bus", "Car", "motorcycle", "Truck"]  # edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/3430016c-9278-4b4d-ab23-631eecfe0078'  #Edit 2
...
with tab1:
  #setting up the title
  st.header("Vehicle Image Classifier")#change according to your project   #edit 3
...
with tab2:
  ...
  #add github link
  st.link_button("My Github Repository", "https://github.com/nagraju/Venhicle_classification")
  ...
  pdf_url = "https://raw.githubusercontent.com/nagraju/Venhicle_classification/main/Vehicle_classification.pdf"
